import { Car, Smartphone, XIcon, Instagram, Linkedin, MapPin, Users, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mb-12">
            <div className="inline-flex items-center bg-white rounded-full px-6 py-3 shadow-lg border border-blue-100 mb-6">
              ...
              <span className="text-gray-700 font-medium">Currently in Development</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold text-gray-800 mb-4">
              Coming Soon
            </h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              We're building the future of daily commuting. Join thousands of early adopters 
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-white/50">
              ...
              <p className="text-gray-600 text-sm">Connect with verified commuters on your route</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-white/50">
              ...
              <p className="text-gray-600 text-sm">Background checks and real-time tracking</p>
            </div>
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-white/50">
              ...
              <p className="text-gray-600 text-sm">AI-powered route optimization</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-2xl mx-auto text-center">
          <h3 className="text-2xl font-bold text-gray-900 mb-8">Coming to Your Platform</h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="border-t border-gray-200 mt-8 pt-8 text-center">
            <p className="text-gray-600">
              Made with Commuter Team❤️ in Egypt
            </p>
          </div>
        </div>
      </footer>
